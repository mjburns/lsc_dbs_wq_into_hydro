...
# ============================================================
# FIG 1 — FULL SCRIPT (MORE ZOOM on main map)
# Changes:
#  - Zoom in "a fair bit" on main plotting window:
#      * smaller padding
#      * optional centre-crop factor (tightens further)
#  - Keeps insets + key + arrows + axis whitespace
# ============================================================
...
# 2) OUTPUT DEVICE
# ---------------------------------------------------
out_file <- "images/Fig1_zoomed_in.tiff"
...
# --- stronger zoom: smaller padding than before ---
pad_x <- 0.010 * w
pad_y <- 0.020 * h
...
# --- optional extra zoom: centre-crop factor (tighten further) ---
# 0.90 = show 90% of width/height around centre (10% zoom-in)
crop_factor <- 0.90
cx <- mean(xlim_pad)
cy <- mean(ylim_pad)
half_w <- 0.5 * diff(xlim_pad) * crop_factor
half_h <- 0.5 * diff(ylim_pad) * crop_factor
