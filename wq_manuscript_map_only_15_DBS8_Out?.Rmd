...
#
# REVERT to the last working baseline:
#  - DBS0004 pipes are spatially clipped to DBS0004 polygon (only)
#  - L4 pipes behaviour unchanged
#  - Axis titles exactly as requested
#  - Compact right-hand legend (no massive whitespace)
# ============================================================
...
# ---------------------------------------------------
# 5.5) Clip pipes to DBS0004 polygon ONLY (spatial)
# ---------------------------------------------------
...
# ---------------------------------------------------
# 8) Export device (high-res TIFF)
# ---------------------------------------------------
dir.create("images", showWarnings = FALSE, recursive = TRUE)
out_file <- "images/SCM_D4e_vs_L4_streams_pipes_catchments_LEGEND_RIGHT_REVERT_v5.tiff"
