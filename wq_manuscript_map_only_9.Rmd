...
# ============================================================
# FIG 1 — FULL SCRIPT (EVEN MORE ZOOM + single ZOOM knob)
# Key knobs:
#   ZOOM       : 1.0 = base extent; higher = zoom in more (e.g., 1.2, 1.5, 1.8)
#   CENTER_DX  : metres (+ right, - left)
#   CENTER_DY  : metres (+ up, - down)
# ============================================================
...
# 2) OUTPUT DEVICE
# ---------------------------------------------------
out_file <- "images/Fig1_zoomed_in_more.tiff"
...
# ---------------------------------------------------
# 3.5) MAIN MAP VIEW KNOBS (THIS IS WHAT YOU TWEAK)
# ---------------------------------------------------
ZOOM       <- 1.35   # <<< increase to zoom in more (e.g., 1.6, 1.8)
CENTER_DX  <- -2000      # metres (optional): + right / - left, #Was 0
CENTER_DY  <- -1000      # metres (optional): + up / - down
PAD_FRAC_X <- 0.008  # base padding before zoom (keep small)
PAD_FRAC_Y <- 0.015  # base padding before zoom (keep small)
...
# ---------------------------------------------------
# 6) MAIN MAP EXTENTS (BASE bbox -> pad -> zoom around centre)
# ---------------------------------------------------
catIA_2009 <- catIA[
