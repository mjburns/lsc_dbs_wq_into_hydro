...
# FIG 1 — FULL SCRIPT
# Updates requested:
#  - Add whitespace between Northing label and tick labels
#  - Rotate "Northing (m)" vertically
#  - Zoom in slightly more on main plot (shrink padding)
#  - Re-introduce the 3 arrows (LS/LM/LN -> LSS0001/LIS0001/LSN0001)
# ============================================================
...
# ---------------------------------------------------
# 6) MAIN MAP EXTENTS (AUTO + slightly zoomed in)
# ---------------------------------------------------
catIA_2009 <- catIA[
...
# ---------------------------------------------------
# KEY CHANGE HERE:
# - mgp second value smaller => tick labels closer to axis
# - (creates more whitespace between tick labels and the axis TITLE)
...
if (inherits(siteLabels_f, "sf") &&
    all(c("siteLabel") %in% names(siteLabels_f)) &&
    all(c("sitecode") %in% names(siteMap11_f))) {
...
# KEY CHANGE HERE:
# - larger line value => axis TITLE further from tick labels (more whitespace)
